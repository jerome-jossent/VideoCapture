...
namespace VideoCapture
{
    public class VideoInInfo
    {
        public class Format
        {
            ...
            public Format(int width, int height, float frameRate, string format, int index)
            {
                w = width;
                h = height;
                fr = frameRate;
        ...
        public static Dictionary<string, Format> EnumerateSupportedFormats_JJ(int deviceIndex)
        {
        ...
        public static IEnumerable<Format> EnumerateSupportedFormats(int deviceIndex)
        {
            var devices = EnumerateVideoDevices();
            if (deviceIndex < devices.Length)
            {
        ...
        public static DsDevice[] EnumerateVideoDevices_JJ()
        {
